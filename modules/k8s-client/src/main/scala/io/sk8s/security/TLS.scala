...
import core.{AuthInfo, CertAuth, PathOrData}
import io.sk8s.core.configuration.Context
import io.sk8s.security.SecurityHelper
...
object TLS {
  ...
  private val skipTLSTrustManagers = Array[TrustManager](InsecureSkipTLSVerifyTrustManager)
